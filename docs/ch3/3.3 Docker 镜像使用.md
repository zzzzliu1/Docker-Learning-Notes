...
docker tag taxi_ingest:v001 \
yourname/taxi_ingest:v001

再：

docker push yourname/taxi_ingest:v001
...
docker pull yourname/taxi_ingest:v001
...
docker rmi 删除镜像
docker image prune 清理缓存
docker search 搜索镜像
docker history 查看构建层
